...
cd ..\deploy\workspace
xcopy  /s ..\windows\user.conf filebeat-5.4.2-windows-x86_64
xcopy /s ..\windows\common.conf filebeat-5.4.2-windows-x86_64
xcopy /s ..\windows\filebeat_template.yml filebeat-5.4.2-windows-x86_64
