...
cd ..\deploy\workspace
xcopy  /s /y ..\user.conf filebeat-5.4.2-windows-x86_64
xcopy /s /y ..\common.conf filebeat-5.4.2-windows-x86_64
xcopy /s /y ..\filebeat_template.yml filebeat-5.4.2-windows-x86_64
